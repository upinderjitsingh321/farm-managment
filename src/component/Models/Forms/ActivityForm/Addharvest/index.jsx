...
function ModelHarvestForm({ show, onclose, croplist }) {
  ...
  const handleSubmitForm = async (data) => {
    ...
    try {
      const res = await axios.post(`${USER.CREATE_HARVEST_ACTIVITY}`, payload, {
        headers: {
          ...
          >
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                ...
                <select {...register("cropId")} name="cropId" className="form-select">
