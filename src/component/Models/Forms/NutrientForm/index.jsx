                    ...
                    <form onSubmit={handleSubmit} className="registration_form shadow p-4 bg-white rounded reg-padding">
                        <div className="row mb-3">
                            <div className="col-md-6">
                                ...
                                <input type="text" className="form-control" id="farmer_name" placeholder='Field No.' onChange={(e) => setFeildNo(e.target.value)} />
                            </div>
                            <div className="col-md-6">
                                <label for="contact" className="form-label">Area(Acre)</label>
                                <input type="email" className="form-control" id="contact" placeholder='Acre' onChange={(e) => setArea(e.target.value)} />
                            </div>
                        </div>
                        <div className="row mb-3">
