          ...
          <div className=' container-right-one edit-con-height'>
            ...
            <img className='profile_photo' src='img/profile-picture.png' />
              <input id='image' type='file' className='d-none'/>
                    <label className='edit-camera-icon' htmlFor='image'><i class="fa-solid fa-camera fs-5" role='button'></i></label>
        ...
        <div style={{ width: "calc(58% - 25px)", marginBottom: "40px" }} className="col-md-7">
          <form onSubmit={handleSubmit} className="registration_form shadow p-4 bg-white rounded">
            ...
            <div className="comman_div_button text-center">
              <button type="submit" className="btn btn-success px-4 py-2 rounded-pill">Save Changes</button>
            </div>
          </form>
        </div>
      </div>
